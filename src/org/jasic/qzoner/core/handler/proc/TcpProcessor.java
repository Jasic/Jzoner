...
import org.jasic.qzoner.common.FilterGenerator;
...
public class TcpProcessor extends AProcessor<TCPPacket> {
    ...
    private void initFilter() {
        ...
        // 添加过滤成http request的请求实体
        FilterLine tcpHttpReqFilterLine = FilterGenerator.genTcpHttpReqFilterLine();
        super.filterParallel.addFilterLine(tcpHttpReqFilterLine);
    ...
    public void doProcess(TCPPacket tcpPacket) {
        ...
        if (date.length > 0) {
            ...
            try {
                ...
                baseData.setData(date);

//                filterParallel.parallelFire(baseData);
